 ...
 */
extern "C" __declspec(dllexport) long GetClassObject(const WCHAR_T*, IComponentBase** pIntf);
extern "C" __declspec(dllexport) long DestroyObject(IComponentBase** pIntf);
extern "C" __declspec(dllexport) const WCHAR_T* GetClassNames();
extern "C" __declspec(dllexport) AppCapabilities SetPlatformCapabilities(const AppCapabilities capabilities);
