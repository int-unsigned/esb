...
#if defined(ESB_VER)
#	if ESB_VER == ESB_VER_v8300 || ESB_VER == ESB_VER_v8311 || ESB_VER == ESB_VER_v8320 || ESB_VER == ESB_VER_v8323
// assume ok
#	else
...
#			define ESB_DETOUR_LIB		PP_STRINGIZE(  PP_CAT(ESB_USE_DETOUR_PATH , /lib.X64/detours.lib)  )
#		endif
