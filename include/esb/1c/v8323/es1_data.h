...
{
	class ValueTable;
	using ValueTable_CheckScriptCircularRefs = ValueTable;
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
	using ТаблицаЗначений_CheckScriptCircularRefs = ValueTable_CheckScriptCircularRefs;
#endif
}
...
class DatabaseCopiesUse;
class RequiredDataRelevance;
class StandardBeginningDateVariant;
...
class UsedDatabaseCopy;
class UsedDatabaseCopies;
class Query;
class ValueListItem;
class ValueList;
...
using ИспользованиеКопийБазыДанных = DatabaseCopiesUse;
using ТребуемаяАктуальностьДанных = RequiredDataRelevance;
using ВариантСтандартнойДатыНачала = StandardBeginningDateVariant;
using СтандартнаяДатаНачала = StandardBeginningDate;
...
using ИспользуемаяКопияБазыДанных = UsedDatabaseCopy;
using ИспользуемыеКопииБазыДанных = UsedDatabaseCopies;
using Запрос = Query;
...
ESB_CLASS_ENUM(DatabaseCopiesUse)
{
	ESB_CLASS_IMPLEMENT_ENUM(DatabaseCopiesUse)
public:
	ESB_CLASS_ENUM_ITEM(Auto, Авто)
	ESB_CLASS_ENUM_ITEM(UseCopiesOnly, ИспользоватьТолькоКопии)
	ESB_CLASS_ENUM_ITEM(PreferUseCopies, ИспользоватьПреимущественноКопии)
	ESB_CLASS_ENUM_ITEM(DontUseCopies, НеИспользоватьКопии)
};


ESB_CLASS_ENUM(RequiredDataRelevance)
{
	ESB_CLASS_IMPLEMENT_ENUM(RequiredDataRelevance)
public:
	ESB_CLASS_ENUM_ITEM(Auto, Авто)
	ESB_CLASS_ENUM_ITEM(Relevant, Актуальные)
	ESB_CLASS_ENUM_ITEM(Any, Любые)
};


ESB_CLASS_ENUM(StandardBeginningDateVariant)
{
	ESB_CLASS_IMPLEMENT_ENUM(StandardBeginningDateVariant)
public:
	ESB_CLASS_ENUM_ITEM(Custom, ПроизвольнаяДата)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisDay, НачалоЭтогоДня)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisWeek, НачалоЭтойНедели)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisTenDays, НачалоЭтойДекады)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisMonth, НачалоЭтогоМесяца)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisQuarter, НачалоЭтогоКвартала)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisHalfYear, НачалоЭтогоПолугодия)
	ESB_CLASS_ENUM_ITEM(BeginningOfThisYear, НачалоЭтогоГода)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastDay, НачалоПрошлогоДня)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastWeek, НачалоПрошлойНедели)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastTenDays, НачалоПрошлойДекады)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastMonth, НачалоПрошлогоМесяца)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastQuarter, НачалоПрошлогоКвартала)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastHalfYear, НачалоПрошлогоПолугодия)
	ESB_CLASS_ENUM_ITEM(BeginningOfLastYear, НачалоПрошлогоГода)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextDay, НачалоСледующегоДня)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextWeek, НачалоСледующейНедели)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextTenDays, НачалоСледующейДекады)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextMonth, НачалоСледующегоМесяца)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextQuarter, НачалоСледующегоКвартала)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextHalfYear, НачалоСледующегоПолугодия)
	ESB_CLASS_ENUM_ITEM(BeginningOfNextYear, НачалоСледующегоГода)
};


ESB_CLASS_OBJECT(StandardBeginningDate)
{
	ESB_CLASS_IMPLEMENT_OBJECT(StandardBeginningDate)
#if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
public:
	static StandardBeginningDate Create() { ESB_INVOKE_CTOR0(StandardBeginningDate); }
	static StandardBeginningDate Create(ConstParam<DateTime> Date_ = DefUndef<esb::DateTime>) { ESB_INVOKE_CTOR1(StandardBeginningDate, Date_); }
	static StandardBeginningDate Create(ConstParam<StandardBeginningDateVariant> Variant_) { ESB_INVOKE_CTOR1(StandardBeginningDate, Variant_); }
public:
	// Свойство [[Чтение,Запись]] Дата Как Дата
	DateTime GetDate() const { ESB_INVOKE_PROPERTY_GET(esb::DateTime, PropId::Date); };
	void SetDate(ConstParam<DateTime> Value_) { ESB_INVOKE_PROPERTY_SET(PropId::Date, Value_); };
	ESB_PROPERTY_FIELD_RW(DateTime, Date)
	// Свойство [[Чтение,Запись]] Вариант Как ВариантСтандартнойДатыНачала
	StandardBeginningDateVariant GetVariant() const { ESB_INVOKE_PROPERTY_GET(esb::StandardBeginningDateVariant, PropId::Variant); };
	void SetVariant(ConstParam<StandardBeginningDateVariant> Value_) { ESB_INVOKE_PROPERTY_SET(PropId::Variant, Value_); };
	ESB_PROPERTY_FIELD_RW(StandardBeginningDateVariant, Variant)
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
public:
	static СтандартнаяДатаНачала Создать() { ESB_INVOKE_CTOR0(СтандартнаяДатаНачала); }
	static СтандартнаяДатаНачала Создать(КонстПарам<ДатаВремя> Дата_ = ПоУмолчаниюНеопределеноИли<esb::ДатаВремя>) { ESB_INVOKE_CTOR1(СтандартнаяДатаНачала, Дата_); }
	static СтандартнаяДатаНачала Создать(КонстПарам<ВариантСтандартнойДатыНачала> Вариант_) { ESB_INVOKE_CTOR1(СтандартнаяДатаНачала, Вариант_); }
public:
	// Property [[Read,Write]] Date -> Date
	ДатаВремя ПолучитьДата() const { ESB_INVOKE_PROPERTY_GET(esb::ДатаВремя, PropId::Date); };
	void УстановитьДата(КонстПарам<ДатаВремя> Значение_) { ESB_INVOKE_PROPERTY_SET(PropId::Date, Значение_); };
	ESB_PROPERTY_FIELD_RW(ДатаВремя, Дата)
	// Property [[Read,Write]] Variant -> StandardBeginningDateVariant
	ВариантСтандартнойДатыНачала ПолучитьВариант() const { ESB_INVOKE_PROPERTY_GET(esb::ВариантСтандартнойДатыНачала, PropId::Variant); };
	void УстановитьВариант(КонстПарам<ВариантСтандартнойДатыНачала> Значение_) { ESB_INVOKE_PROPERTY_SET(PropId::Variant, Значение_); };
	ESB_PROPERTY_FIELD_RW(ВариантСтандартнойДатыНачала, Вариант)
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
};
...
// Функция Найти(ИмяКолонки_ Как Строка) Возвращает ОдинИз<Неопределено, КолонкаТаблицыЗначений>
UndefOr<ValueTableColumn> Find(ConstParam<String> ColumnName_) {ESB_INVOKE_MEMB_FUNC1(UndefOr<esb::ValueTableColumn>, MethId::Find, ColumnName_);};
...
// Function Find(String ColumnName_) -> OneOf<Undefined, ValueTableColumn>
НеопределеноИли<КолонкаТаблицыЗначений> Найти(КонстПарам<Строка> ИмяКолонки_) {ESB_INVOKE_MEMB_FUNC1(НеопределеноИли<esb::КолонкаТаблицыЗначений>, MethId::Find, ИмяКолонки_);};
...
ValueTable Owner() const;// {ESB_INVOKE_MEMB_FUNC0(esb::ValueTable, MethId::Owner); };
...
ТаблицаЗначений Владелец() const;// {ESB_INVOKE_MEMB_FUNC0(esb::ТаблицаЗначений, MethId::Owner); };
...
// Функция Количество() Возвращает Число
Number Count() const {ESB_INVOKE_MEMB_FUNC0(esb::Number, MethId::Count);};
// Процедура Удалить(Индекс_ Как Число)
void Delete(ConstParam<Number> Index_) {ESB_INVOKE_MEMB_PROC1(MethId::Delete, Index_);};
// Процедура Удалить(Индекс_ Как Число)
...
// Процедура Очистить()
void Clear() {ESB_INVOKE_MEMB_PROC0(MethId::Clear);};
// Функция Скопировать([ПараметрыОтбора_ Как Структура], [Колонки_ Как Строка]) Возвращает ТаблицаЗначений
...
// Void Clear()
void Очистить() {ESB_INVOKE_MEMB_PROC0(MethId::Clear);};
// Function Copy(Structure ParametersOfFilter_ = <default>, String Columns_ = <default>) -> ValueTable
...
ValueTree Owner() const;// {ESB_INVOKE_MEMB_FUNC0(esb::ValueTree, MethId::Owner); };
// Процедура Установить(Индекс_ Как Число, Значение_ Как Произвольный)
void Set(ConstParam<Number> Index_, ConstParam<Arbitrary> Value_) {ESB_INVOKE_MEMB_PROC2(MethId::Set, Index_, Value_);};
public:
...
ValueTreeRowCollection GetRows() const;// { ESB_INVOKE_PROPERTY_GET(esb::ValueTreeRowCollection, PropId::Rows); };
...
ДеревоЗначений Владелец() const;// {ESB_INVOKE_MEMB_FUNC0(esb::ДеревоЗначений, MethId::Owner); };
// Void Set(Number Index_, Arbitrary Value_)
void Установить(КонстПарам<Число> Индекс_, КонстПарам<Произвольный> Значение_) {ESB_INVOKE_MEMB_PROC2(MethId::Set, Индекс_, Значение_);};
public:
...
КоллекцияСтрокДереваЗначений ПолучитьСтроки() const;// { ESB_INVOKE_PROPERTY_GET(esb::КоллекцияСтрокДереваЗначений, PropId::Rows); };
...
// Процедура Сдвинуть(Строка_ Как Число, Смещение_ Как Число)
void Move(ConstParam<Number> Row_, ConstParam<Number> Offset_) {ESB_INVOKE_MEMB_PROC2(MethId::Move, Row_, Offset_);};
...
// Void Move(Number Row_, Number Offset_)
void Сдвинуть(КонстПарам<Число> Строка_, КонстПарам<Число> Смещение_) {ESB_INVOKE_MEMB_PROC2(MethId::Move, Строка_, Смещение_);};
...
// Функция Количество() Возвращает Число
Number Count() const {ESB_INVOKE_MEMB_FUNC0(esb::Number, MethId::Count);};
// Функция НайтиСледующий(Значение_ Как Произвольный, [Колонки_ Как Строка]) Возвращает Булево
...
QueryResult Owner() const;// {ESB_INVOKE_MEMB_FUNC0(esb::QueryResult, MethId::Owner); };
...
// Function Count() -> Number
Число Количество() const {ESB_INVOKE_MEMB_FUNC0(esb::Число, MethId::Count);};
// Function FindNext(Arbitrary Value_, String Columns_ = <default>) -> Boolean
...
РезультатЗапроса Владелец() const;// {ESB_INVOKE_MEMB_FUNC0(esb::РезультатЗапроса, MethId::Owner); };
...
// Свойство [[ТолькоЧтение]] КопияБазыДанных Как Строка
String GetDatabaseCopy() const  { ESB_INVOKE_PROPERTY_GET(esb::String, PropId::DatabaseCopy); };
ESB_PROPERTY_FIELD_RO(String, DatabaseCopy)
// Свойство [[ТолькоЧтение]] ДанныеАктуальны Как Булево
Boolean GetDataIsRelevant() const  { ESB_INVOKE_PROPERTY_GET(esb::Boolean, PropId::DataIsRelevant); };
ESB_PROPERTY_FIELD_RO(Boolean, DataIsRelevant)
// Свойство [[ТолькоЧтение]] ВремяАктуальностиДанных Как Дата
DateTime GetDataRelevanceTime() const  { ESB_INVOKE_PROPERTY_GET(esb::DateTime, PropId::DataRelevanceTime); };
ESB_PROPERTY_FIELD_RO(DateTime, DataRelevanceTime)
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
public:
// Not Creatable
...
// Property [[ReadOnly]] DatabaseCopy -> String
Строка ПолучитьКопияБазыДанных() const  { ESB_INVOKE_PROPERTY_GET(esb::Строка, PropId::DatabaseCopy); };
ESB_PROPERTY_FIELD_RO(Строка, КопияБазыДанных)
// Property [[ReadOnly]] DataIsRelevant -> Boolean
Булево ПолучитьДанныеАктуальны() const  { ESB_INVOKE_PROPERTY_GET(esb::Булево, PropId::DataIsRelevant); };
ESB_PROPERTY_FIELD_RO(Булево, ДанныеАктуальны)
// Property [[ReadOnly]] DataRelevanceTime -> Date
ДатаВремя ПолучитьВремяАктуальностиДанных() const  { ESB_INVOKE_PROPERTY_GET(esb::ДатаВремя, PropId::DataRelevanceTime); };
ESB_PROPERTY_FIELD_RO(ДатаВремя, ВремяАктуальностиДанных)
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
};
...
ESB_CLASS_OBJECT(UsedDatabaseCopy)
{
	ESB_CLASS_IMPLEMENT_OBJECT(UsedDatabaseCopy)
#if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
public:
	// Not Creatable
public:
...
ESB_CLASS_OBJECT_DUAL(UsedDatabaseCopies, AxCollectionRO<Arbitrary, UsedDatabaseCopy>)
{
	ESB_CLASS_IMPLEMENT_OBJECT_DUAL(UsedDatabaseCopies)
#if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
public:
	// Not Creatable
public:
	// Функция Добавить(Имя_ Как Строка) Возвращает ИспользуемаяКопияБазыДанных
	UsedDatabaseCopy Add(ConstParam<String> Name_) { ESB_INVOKE_MEMB_FUNC1(esb::UsedDatabaseCopy, MethId::Add, Name_); };
	// Процедура Очистить()
	void Clear() { ESB_INVOKE_MEMB_PROC0(MethId::Clear); };
	// Функция Количество() Возвращает Число
	Number Count() { ESB_INVOKE_MEMB_FUNC0(esb::Number, MethId::Count); };
	// Процедура Удалить(Элемент_ Как ОдинИз<Число, ИспользуемаяКопияБазыДанных>)
	void Delete(ConstParam<Number> Item_) { ESB_INVOKE_MEMB_PROC1(MethId::Delete, Item_); };
	void Delete(ConstParam<UsedDatabaseCopy> Item_) { ESB_INVOKE_MEMB_PROC1(MethId::Delete, Item_); };
	// Функция Найти(Имя_ Как Строка) Возвращает ИспользуемаяКопияБазыДанных
	UsedDatabaseCopy Find(ConstParam<String> Name_) { ESB_INVOKE_MEMB_FUNC1(esb::UsedDatabaseCopy, MethId::Find, Name_); };
	// Функция Получить(Индекс_ Как Число) Возвращает ИспользуемаяКопияБазыДанных
	UsedDatabaseCopy Get(ConstParam<Number> Index_) { ESB_INVOKE_MEMB_FUNC1(esb::UsedDatabaseCopy, MethId::Get, Index_); };
	// Функция Индекс(Элемент_ Как ИспользуемаяКопияБазыДанных) Возвращает Число
	Number IndexOf(ConstParam<UsedDatabaseCopy> Item_) { ESB_INVOKE_MEMB_FUNC1(esb::Number, MethId::IndexOf, Item_); };
	// Функция Вставить(Индекс_ Как Число, Имя_ Как Строка) Возвращает ИспользуемаяКопияБазыДанных
	UsedDatabaseCopy Insert(ConstParam<Number> Index_, ConstParam<String> Name_) { ESB_INVOKE_MEMB_FUNC2(esb::UsedDatabaseCopy, MethId::Insert, Index_, Name_); };
	// Процедура Сдвинуть(Элемент_ Как ОдинИз<Число, ИспользуемаяКопияБазыДанных>, Смещение_ Как Число)
	void Move(ConstParam<Number> Item_, ConstParam<Number> Offset_) { ESB_INVOKE_MEMB_PROC2(MethId::Move, Item_, Offset_); };
	void Move(ConstParam<UsedDatabaseCopy> Item_, ConstParam<Number> Offset_) { ESB_INVOKE_MEMB_PROC2(MethId::Move, Item_, Offset_); };
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
public:
	// Not Creatable
public:
	// Function Add(String Name_) -> UsedDatabaseCopy
	ИспользуемаяКопияБазыДанных Добавить(КонстПарам<Строка> Имя_) { ESB_INVOKE_MEMB_FUNC1(esb::ИспользуемаяКопияБазыДанных, MethId::Add, Имя_); };
	// Void Clear()
	void Очистить() { ESB_INVOKE_MEMB_PROC0(MethId::Clear); };
	// Function Count() -> Number
	Число Количество() { ESB_INVOKE_MEMB_FUNC0(esb::Число, MethId::Count); };
	// Void Delete(OneOf<Number, UsedDatabaseCopy> Item_)
	void Удалить(КонстПарам<Число> Элемент_) { ESB_INVOKE_MEMB_PROC1(MethId::Delete, Элемент_); };
	void Удалить(КонстПарам<ИспользуемаяКопияБазыДанных> Элемент_) { ESB_INVOKE_MEMB_PROC1(MethId::Delete, Элемент_); };
	// Function Find(String Name_) -> UsedDatabaseCopy
	ИспользуемаяКопияБазыДанных Найти(КонстПарам<Строка> Имя_) { ESB_INVOKE_MEMB_FUNC1(esb::ИспользуемаяКопияБазыДанных, MethId::Find, Имя_); };
	// Function Get(Number Index_) -> UsedDatabaseCopy
	ИспользуемаяКопияБазыДанных Получить(КонстПарам<Число> Индекс_) { ESB_INVOKE_MEMB_FUNC1(esb::ИспользуемаяКопияБазыДанных, MethId::Get, Индекс_); };
	// Function IndexOf(UsedDatabaseCopy Item_) -> Number
	Число Индекс(КонстПарам<ИспользуемаяКопияБазыДанных> Элемент_) { ESB_INVOKE_MEMB_FUNC1(esb::Число, MethId::IndexOf, Элемент_); };
	// Function Insert(Number Index_, String Name_) -> UsedDatabaseCopy
	ИспользуемаяКопияБазыДанных Вставить(КонстПарам<Число> Индекс_, КонстПарам<Строка> Имя_) { ESB_INVOKE_MEMB_FUNC2(esb::ИспользуемаяКопияБазыДанных, MethId::Insert, Индекс_, Имя_); };
	// Void Move(OneOf<Number, UsedDatabaseCopy> Item_, Number Offset_)
	void Сдвинуть(КонстПарам<Число> Элемент_, КонстПарам<Число> Смещение_) { ESB_INVOKE_MEMB_PROC2(MethId::Move, Элемент_, Смещение_); };
	void Сдвинуть(КонстПарам<ИспользуемаяКопияБазыДанных> Элемент_, КонстПарам<Число> Смещение_) { ESB_INVOKE_MEMB_PROC2(MethId::Move, Элемент_, Смещение_); };
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
public:
	ESB_IMPLEMENT_ENUM_ITEMS(UsedDatabaseCopies, UsedDatabaseCopy)
public:
	// MANUAL!!! ESB_IMPLEMENT_ASSICIATIVE_COLLECTION()
};
...
public:
// Свойство [[Чтение,Запись]] ИспользованиеКопийБазыДанных Как ИспользованиеКопийБазыДанных
DatabaseCopiesUse GetDatabaseCopiesUse() const  { ESB_INVOKE_PROPERTY_GET(esb::DatabaseCopiesUse, PropId::DatabaseCopiesUse); };
void SetDatabaseCopiesUse(ConstParam<DatabaseCopiesUse> Value_)  { ESB_INVOKE_PROPERTY_SET(PropId::DatabaseCopiesUse, Value_); };
ESB_PROPERTY_FIELD_RW(DatabaseCopiesUse, DatabaseCopiesUse)
...
// Свойство [[Чтение,Запись]] ТребуемаяАктуальностьДанных Как ТребуемаяАктуальностьДанных
RequiredDataRelevance GetRequiredDataRelevance() const  { ESB_INVOKE_PROPERTY_GET(esb::RequiredDataRelevance, PropId::RequiredDataRelevance); };
void SetRequiredDataRelevance(ConstParam<RequiredDataRelevance> Value_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevance, Value_); };
ESB_PROPERTY_FIELD_RW(RequiredDataRelevance, RequiredDataRelevance)
// Свойство [[Чтение,Запись]] ТребуемоеВремяАктуальностиДанных Как ОдинИз<Дата, Число, СтандартнаяДатаНачала>
OneOf<Number, DateTime, StandardBeginningDate> GetRequiredDataRelevanceTime() const  { ESB_INVOKE_PROPERTY_GET(ESB_ONEOF(esb::Number, esb::DateTime, esb::StandardBeginningDate), PropId::RequiredDataRelevanceTime); };
void SetRequiredDataRelevanceTime(ConstParam<Number> Value_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Value_); };
void SetRequiredDataRelevanceTime(ConstParam<DateTime> Value_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Value_); };
void SetRequiredDataRelevanceTime(ConstParam<StandardBeginningDate> Value_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Value_); };
...
// Свойство [[ТолькоЧтение]] ИспользуемыеКопииБазыДанных Как ИспользуемыеКопииБазыДанных
UsedDatabaseCopies GetUsedDatabaseCopies() const  { ESB_INVOKE_PROPERTY_GET(esb::UsedDatabaseCopies, PropId::UsedDatabaseCopies); };
ESB_PROPERTY_FIELD_RO(UsedDatabaseCopies, UsedDatabaseCopies)
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
public:
...
public:
// Property [[Read,Write]] DatabaseCopiesUse -> DatabaseCopiesUse
ИспользованиеКопийБазыДанных ПолучитьИспользованиеКопийБазыДанных() const  { ESB_INVOKE_PROPERTY_GET(esb::ИспользованиеКопийБазыДанных, PropId::DatabaseCopiesUse); };
void УстановитьИспользованиеКопийБазыДанных(КонстПарам<ИспользованиеКопийБазыДанных> Значение_)  { ESB_INVOKE_PROPERTY_SET(PropId::DatabaseCopiesUse, Значение_); };
ESB_PROPERTY_FIELD_RW(ИспользованиеКопийБазыДанных, ИспользованиеКопийБазыДанных)
...
// Property [[Read,Write]] RequiredDataRelevance -> RequiredDataRelevance
ТребуемаяАктуальностьДанных ПолучитьТребуемаяАктуальностьДанных() const  { ESB_INVOKE_PROPERTY_GET(esb::ТребуемаяАктуальностьДанных, PropId::RequiredDataRelevance); };
void УстановитьТребуемаяАктуальностьДанных(КонстПарам<ТребуемаяАктуальностьДанных> Значение_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevance, Значение_); };
ESB_PROPERTY_FIELD_RW(ТребуемаяАктуальностьДанных, ТребуемаяАктуальностьДанных)
// Property [[Read,Write]] RequiredDataRelevanceTime -> OneOf<Date, Number, StandardBeginningDate>
ОдинИз<Число, ДатаВремя, СтандартнаяДатаНачала> ПолучитьТребуемоеВремяАктуальностиДанных() const  { ESB_INVOKE_PROPERTY_GET(ESB_ONEOF(esb::Число, esb::ДатаВремя, esb::СтандартнаяДатаНачала), PropId::RequiredDataRelevanceTime); };
void УстановитьТребуемоеВремяАктуальностиДанных(КонстПарам<Число> Значение_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Значение_); };
void УстановитьТребуемоеВремяАктуальностиДанных(КонстПарам<ДатаВремя> Значение_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Значение_); };
void УстановитьТребуемоеВремяАктуальностиДанных(КонстПарам<СтандартнаяДатаНачала> Значение_)  { ESB_INVOKE_PROPERTY_SET(PropId::RequiredDataRelevanceTime, Значение_); };
...
// Property [[ReadOnly]] UsedDatabaseCopies -> UsedDatabaseCopies
ИспользуемыеКопииБазыДанных ПолучитьИспользуемыеКопииБазыДанных() const  { ESB_INVOKE_PROPERTY_GET(esb::ИспользуемыеКопииБазыДанных, PropId::UsedDatabaseCopies); };
ESB_PROPERTY_FIELD_RO(ИспользуемыеКопииБазыДанных, ИспользуемыеКопииБазыДанных)
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
};
...
// Функция ОтметитьЭлементыАсинх([Заголовок_ Как Строка]) Возвращает Обещание<СписокЗначений>
Promise<ValueList> CheckItemsAsync(ConstParam<String> Title_ = DefUndef<esb::String>) {ESB_INVOKE_MEMB_FUNC1(esb::Promise<ValueList>, MethId::CheckItemsAsync, Title_);};
...
// Функция ВыбратьЭлементАсинх([Заголовок_ Как Строка], [Элемент_ Как ЭлементСпискаЗначений]) Возвращает Обещание<ЭлементСпискаЗначений>
Promise<ValueListItem> ChooseItemAsync(ConstParam<String> Title_ = DefUndef<esb::String>, ConstParam<ValueListItem> Item_ = DefUndef<esb::ValueListItem>) {ESB_INVOKE_MEMB_FUNC2(esb::Promise<ValueListItem>, MethId::ChooseItemAsync, Title_, Item_);};
// Процедура Очистить()
void Clear() {ESB_INVOKE_MEMB_PROC0(MethId::Clear);};
...
void ShowCheckItems(ConstParam<CallbackDescription> NotifyOnCloseDescription_, ConstParam<String> Title_ = DefUndef<esb::String>) {ESB_INVOKE_MEMB_PROC2(MethId::ShowCheckItems, NotifyOnCloseDescription_, Title_);};
...
void ShowChooseItem(ConstParam<CallbackDescription> NotifyOnCloseDescription_, ConstParam<String> Title_ = DefUndef<esb::String>, ConstParam<ValueListItem> Item_ = DefUndef<esb::ValueListItem>) const {ESB_INVOKE_MEMB_PROC3(MethId::ShowChooseItem, NotifyOnCloseDescription_, Title_, Item_);};
...
// Function CheckItemsAsync(String Title_ = <default>) -> Promise<ValueList>
Обещание<СписокЗначений> ОтметитьЭлементыАсинх(КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<esb::Строка>) {ESB_INVOKE_MEMB_FUNC1(esb::Обещание<СписокЗначений>, MethId::CheckItemsAsync, Заголовок_);};
...
// Function ChooseItemAsync(String Title_ = <default>, ValueListItem Item_ = <default>) -> Promise<ValueListItem>
Обещание<ЭлементСпискаЗначений> ВыбратьЭлементАсинх(КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<esb::Строка>, КонстПарам<ЭлементСпискаЗначений> Элемент_ = ПоУмолчаниюНеопределеноИли<esb::ЭлементСпискаЗначений>) {ESB_INVOKE_MEMB_FUNC2(esb::Обещание<ЭлементСпискаЗначений>, MethId::ChooseItemAsync, Заголовок_, Элемент_);};
// Void Clear()
void Очистить() {ESB_INVOKE_MEMB_PROC0(MethId::Clear);};
...
// Void ShowCheckItems(CallbackDescription NotifyOnCloseDescription_, String Title_ = <default>)
...
// Void ShowChooseItem(CallbackDescription NotifyOnCloseDescription_, String Title_ = <default>, ValueListItem Item_ = <default>)
...
//!> the method is actually a function according to disp-information.
// Процедура ВыгрузитьЖурналРегистрации(Приемник_ Как ОдинИз<Строка, ТаблицаЗначений>, [Отбор_ Как Структура], [Колонки_ Как Строка], [ИмяВходногоФайла_ Как Строка], [МаксимальноеКоличество_ Как Число])
inline void UnloadEventLog(ConstParam<String> Destination_, ConstParam<Structure> Filter_ = DefUndef<Structure>, ConstParam<String> Columns_ = DefUndef<String>, ConstParam<String> InputFileName_ = DefUndef<String>, ConstParam<Number> MaximumCount_ = DefUndef<Number>) {ESB_INVOKE_API_PROC5(backend0x7, UnloadEventLog, Destination_, Filter_, Columns_, InputFileName_, MaximumCount_);};
inline void UnloadEventLog(ConstParam<ValueTable> Destination_, ConstParam<Structure> Filter_ = DefUndef<Structure>, ConstParam<String> Columns_ = DefUndef<String>, ConstParam<String> InputFileName_ = DefUndef<String>, ConstParam<Number> MaximumCount_ = DefUndef<Number>) {ESB_INVOKE_API_PROC5(backend0x7, UnloadEventLog, Destination_, Filter_, Columns_, InputFileName_, MaximumCount_);};
...
// Функция ПроверитьЦиклическиеСсылкиВстроенногоЯзыка([Значение_ Как Произвольный], [ОписаниеЗначения_ Как Строка]) Возвращает ТаблицаЗначений_CheckScriptCircularRefs
inline ValueTable_CheckScriptCircularRefs CheckScriptCircularRefs(ConstParam<Arbitrary> Value_ = DefUndef<Arbitrary>, ConstParam<String> ValueDescription_ = DefUndef<String>) {ESB_INVOKE_API_FUNC2(ValueTable_CheckScriptCircularRefs, backend0x7, CheckScriptCircularRefs, Value_, ValueDescription_);};
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
...
//!> the method is actually a function according to disp-information.
// Void UnloadEventLog(OneOf<String, ValueTable> Destination_, Structure Filter_ = <default>, String Columns_ = <default>, String InputFileName_ = <default>, Number MaximumCount_ = <default>)
inline void ВыгрузитьЖурналРегистрации(КонстПарам<Строка> Приемник_, КонстПарам<Структура> Отбор_ = ПоУмолчаниюНеопределеноИли<Структура>, КонстПарам<Строка> Колонки_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Строка> ИмяВходногоФайла_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Число> МаксимальноеКоличество_ = ПоУмолчаниюНеопределеноИли<Число>) {ESB_INVOKE_API_PROC5(backend0x7, UnloadEventLog, Приемник_, Отбор_, Колонки_, ИмяВходногоФайла_, МаксимальноеКоличество_);};
inline void ВыгрузитьЖурналРегистрации(КонстПарам<ТаблицаЗначений> Приемник_, КонстПарам<Структура> Отбор_ = ПоУмолчаниюНеопределеноИли<Структура>, КонстПарам<Строка> Колонки_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Строка> ИмяВходногоФайла_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Число> МаксимальноеКоличество_ = ПоУмолчаниюНеопределеноИли<Число>) {ESB_INVOKE_API_PROC5(backend0x7, UnloadEventLog, Приемник_, Отбор_, Колонки_, ИмяВходногоФайла_, МаксимальноеКоличество_);};
...
// Function CheckScriptCircularRefs(Arbitrary Value_ = <default>, String ValueDescription_ = <default>) -> ValueTable_CheckScriptCircularRefs
inline ТаблицаЗначений_CheckScriptCircularRefs ПроверитьЦиклическиеСсылкиВстроенногоЯзыка(КонстПарам<Произвольный> Значение_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> ОписаниеЗначения_ = ПоУмолчаниюНеопределеноИли<Строка>) {ESB_INVOKE_API_FUNC2(ТаблицаЗначений_CheckScriptCircularRefs, backend0x7, CheckScriptCircularRefs, Значение_, ОписаниеЗначения_);};
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
...
#if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
// Функция Вопрос(ТекстВопроса_ Как ОдинИз<ФорматированнаяСтрока, Строка>, Кнопки_ Как ОдинИз<РежимДиалогаВопрос, СписокЗначений>, [Таймаут_ Как Число], [КнопкаПоУмолчанию_ Как Произвольный], [Заголовок_ Как Строка], [КнопкаТаймаута_ Как Произвольный]) Возвращает Произвольный
inline Arbitrary DoQueryBox(ConstParam<String> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Arbitrary, frntend, DoQueryBox, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Arbitrary DoQueryBox(ConstParam<String> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Arbitrary, frntend, DoQueryBox, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Arbitrary DoQueryBox(ConstParam<FormattedString> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Arbitrary, frntend, DoQueryBox, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Arbitrary DoQueryBox(ConstParam<FormattedString> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Arbitrary, frntend, DoQueryBox, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
// Функция ПользователиWindows() Возвращает ОдинИз<Массив, ТаблицаЗначений>
inline OneOf<Array, ValueTable> WindowsUsers() {ESB_INVOKE_API_FUNC0(ESB_ONEOF(Array, ValueTable), frntend, WindowsUsers);};
// Функция ПользователиОС() Возвращает ОдинИз<Массив, ТаблицаЗначений>
inline OneOf<Array, ValueTable> OSUsers() {ESB_INVOKE_API_FUNC0(ESB_ONEOF(Array, ValueTable), frntend, OSUsers);};
// Процедура ПоказатьВопрос(ОписаниеОповещенияОЗавершении_ Как ОписаниеОповещения, ТекстВопроса_ Как ОдинИз<ФорматированнаяСтрока, Строка>, Кнопки_ Как ОдинИз<РежимДиалогаВопрос, СписокЗначений>, [Таймаут_ Как Число], [КнопкаПоУмолчанию_ Как Произвольный], [Заголовок_ Как Строка], [КнопкаТаймаута_ Как Произвольный])
inline void ShowQueryBox(ConstParam<CallbackDescription> CallbackDescriptionOnCompletion_, ConstParam<String> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, CallbackDescriptionOnCompletion_, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline void ShowQueryBox(ConstParam<CallbackDescription> CallbackDescriptionOnCompletion_, ConstParam<String> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, CallbackDescriptionOnCompletion_, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline void ShowQueryBox(ConstParam<CallbackDescription> CallbackDescriptionOnCompletion_, ConstParam<FormattedString> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, CallbackDescriptionOnCompletion_, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline void ShowQueryBox(ConstParam<CallbackDescription> CallbackDescriptionOnCompletion_, ConstParam<FormattedString> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, CallbackDescriptionOnCompletion_, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
// Функция ВопросАсинх(ТекстВопроса_ Как ОдинИз<ФорматированнаяСтрока, Строка>, Кнопки_ Как ОдинИз<РежимДиалогаВопрос, СписокЗначений>, [Таймаут_ Как Число], [КнопкаПоУмолчанию_ Как Произвольный], [Заголовок_ Как Строка], [КнопкаТаймаута_ Как Произвольный]) Возвращает Обещание<>
inline Promise<> DoQueryBoxAsync(ConstParam<String> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Promise<>, frntend, DoQueryBoxAsync, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Promise<> DoQueryBoxAsync(ConstParam<String> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Promise<>, frntend, DoQueryBoxAsync, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Promise<> DoQueryBoxAsync(ConstParam<FormattedString> QueryText_, ConstParam<QuestionDialogMode> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Promise<>, frntend, DoQueryBoxAsync, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
inline Promise<> DoQueryBoxAsync(ConstParam<FormattedString> QueryText_, ConstParam<ValueList> Buttons_, ConstParam<Number> Timeout_ = DefUndef<Number>, ConstParam<Arbitrary> DefaultButton_ = DefUndef<Arbitrary>, ConstParam<String> Title_ = DefUndef<String>, ConstParam<Arbitrary> TimeoutButton_ = DefUndef<Arbitrary>) {ESB_INVOKE_API_FUNC6(Promise<>, frntend, DoQueryBoxAsync, QueryText_, Buttons_, Timeout_, DefaultButton_, Title_, TimeoutButton_);};
#endif	// #if defined(ESB_USE_ENGLISH) && ESB_USE_ENGLISH
#if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
// Function DoQueryBox(OneOf<FormattedString, String> QueryText_, OneOf<QuestionDialogMode, ValueList> Buttons_, Number Timeout_ = <default>, Arbitrary DefaultButton_ = <default>, String Title_ = <default>, Arbitrary TimeoutButton_ = <default>) -> Arbitrary
inline Произвольный Вопрос(КонстПарам<Строка> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Произвольный, frntend, DoQueryBox, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Произвольный Вопрос(КонстПарам<Строка> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Произвольный, frntend, DoQueryBox, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Произвольный Вопрос(КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Произвольный, frntend, DoQueryBox, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Произвольный Вопрос(КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Произвольный, frntend, DoQueryBox, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
// Function WindowsUsers() -> OneOf<Array, ValueTable>
inline ОдинИз<Массив, ТаблицаЗначений> ПользователиWindows() {ESB_INVOKE_API_FUNC0(ESB_ONEOF(Массив, ТаблицаЗначений), frntend, WindowsUsers);};
// Function OSUsers() -> OneOf<Array, ValueTable>
inline ОдинИз<Массив, ТаблицаЗначений> ПользователиОС() {ESB_INVOKE_API_FUNC0(ESB_ONEOF(Массив, ТаблицаЗначений), frntend, OSUsers);};
// Void ShowQueryBox(CallbackDescription CallbackDescriptionOnCompletion_, OneOf<FormattedString, String> QueryText_, OneOf<QuestionDialogMode, ValueList> Buttons_, Number Timeout_ = <default>, Arbitrary DefaultButton_ = <default>, String Title_ = <default>, Arbitrary TimeoutButton_ = <default>)
inline void ПоказатьВопрос(КонстПарам<ОписаниеОповещения> ОписаниеОповещенияОЗавершении_, КонстПарам<Строка> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, ОписаниеОповещенияОЗавершении_, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline void ПоказатьВопрос(КонстПарам<ОписаниеОповещения> ОписаниеОповещенияОЗавершении_, КонстПарам<Строка> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, ОписаниеОповещенияОЗавершении_, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline void ПоказатьВопрос(КонстПарам<ОписаниеОповещения> ОписаниеОповещенияОЗавершении_, КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, ОписаниеОповещенияОЗавершении_, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline void ПоказатьВопрос(КонстПарам<ОписаниеОповещения> ОписаниеОповещенияОЗавершении_, КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_PROC7(frntend, ShowQueryBox, ОписаниеОповещенияОЗавершении_, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
// Function DoQueryBoxAsync(OneOf<FormattedString, String> QueryText_, OneOf<QuestionDialogMode, ValueList> Buttons_, Number Timeout_ = <default>, Arbitrary DefaultButton_ = <default>, String Title_ = <default>, Arbitrary TimeoutButton_ = <default>) -> Promise<>
inline Обещание<> ВопросАсинх(КонстПарам<Строка> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Обещание<>, frntend, DoQueryBoxAsync, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Обещание<> ВопросАсинх(КонстПарам<Строка> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Обещание<>, frntend, DoQueryBoxAsync, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Обещание<> ВопросАсинх(КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<РежимДиалогаВопрос> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Обещание<>, frntend, DoQueryBoxAsync, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
inline Обещание<> ВопросАсинх(КонстПарам<ФорматированнаяСтрока> ТекстВопроса_, КонстПарам<СписокЗначений> Кнопки_, КонстПарам<Число> Таймаут_ = ПоУмолчаниюНеопределеноИли<Число>, КонстПарам<Произвольный> КнопкаПоУмолчанию_ = ПоУмолчаниюНеопределеноИли<Произвольный>, КонстПарам<Строка> Заголовок_ = ПоУмолчаниюНеопределеноИли<Строка>, КонстПарам<Произвольный> КнопкаТаймаута_ = ПоУмолчаниюНеопределеноИли<Произвольный>) {ESB_INVOKE_API_FUNC6(Обещание<>, frntend, DoQueryBoxAsync, ТекстВопроса_, Кнопки_, Таймаут_, КнопкаПоУмолчанию_, Заголовок_, КнопкаТаймаута_);};
#endif	// #if defined(ESB_USE_RUSSIAN) && ESB_USE_RUSSIAN
